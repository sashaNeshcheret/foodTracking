...
public class DAOUsersImpl implements DAOUsers {
    ...
    private static  final String SQL_DELETE = "DELETE from user_contact WHERE login = ?";
    ...
    public void create(UserContact userContact) throws DAOException {
        try(ConnectionWrapper connection = TransactionManager.getConnection()) {
            ...
            logger.error(String.format("Method create(userContact " + userContact + ") has thrown an exception."));
    ...
    public UserContact read(String login) throws DAOException {
        ...
        try(ConnectionWrapper connection = TransactionManager.getConnection()) {
            ...
            logger.error(String.format("Method read(login: '%s') has thrown an exception.", login));
    ...
    public void delete(String login) throws DAOException {
        try(ConnectionWrapper connection = TransactionManager.getConnection()) {
            ...
            logger.error(String.format("Method delete(login: '%s') has thrown an exception.", login));
