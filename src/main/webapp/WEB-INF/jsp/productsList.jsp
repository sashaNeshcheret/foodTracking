    ...
    <tr colspan="2"  valign="center" align="center">
        <td width="25%">
            <c:if test = "${categoryId != 1}">
                <form align="center" name="chooseCategory" method="GET" action="servlet">
                <input type="hidden" name="command" value="chooseCategory" />
                <input type="hidden" name="id" value=${categoryId-1} />
                <input type="submit" value="previous category"/>
            </c:if>
        </form>
        </td>
        ...
        <td width="25%">
            <form align="center" name="chooseCategory" method="GET" action="servlet">
                <input type="hidden" name="command" value="chooseCategory" />
                <input type="hidden" name="id" value=${categoryId+1} />
                <input type="submit" value="next category"/>
            </form>
        </td>
    </tr>
...
<form align="center" name="addEatenProducts" method="GET" action="servlet">
    ...
    <input align="center" type="submit" value="Add All Products"/>
</form>
